class Report::GeneralReport < Report::Base
    ...
    def main_content
        ...
        self.column_box([0, 650], :columns => 2, :width => self.bounds.width, :height => 630, :overflow => :truncate) do
            ...
            #METAL ORES HEADING 
            heading("METAL ORES", @main_heading_break, @main_content_heading_format)			

            #Iron ore
            draw_price_point(col, @prices, :iron_ore, price_point_size, vertical_padding)
            move_down @after_price_break
            draw_stories(@section_break, @stories_format, @iron_ore_stories)   
            ...
            move_down @after_price_break
            draw_stories(@section_break, @stories_format, @manganese_ore_stories)
            ...
            heading("PRECIOUS METALS", @main_heading_break, @main_content_heading_format)
            ...
            heading("Platinum & Palladium", @main_heading_break, @sub_content_heading_format)	
            ...
            move_down @after_price_break	
            draw_stories(@section_break, @stories_format, @diamonds_stories)

            #BASE METALS HEADING
            position = check_position(position, '7')
            col = 2 if position['7'] - position['6'] > 0
            heading("BASE METALS", @main_heading_break, @main_content_heading_format)		
            ...
            move_down @after_price_break
            draw_stories(@section_break, @stories_format, @aluminium_stories)
            ...
            heading("ENERGY COMMODITIES", @main_heading_break, @main_content_heading_format)		
            ...
            col = 2 if position['11'] - position['10'] > 0
            heading("Oil & Gas", @main_heading_break, @sub_content_heading_format)		
        ...
        @prices.clone.each do |comm, p|
            ...
            for i in 0...arr.length do
                ...
                if wrd.upcase == "SIDE" || wrd.upcase == "FLAT"
                    arr[i] = "<font name='symbols' size='9'><color rgb='000000'> : </color></font>"
                elsif wrd.upcase == "DOWN"
                    arr[i] = "<font name='symbols' size='9'><color rgb='D45A2A'> = </color></font>"
                elsif wrd.upcase == "UP"
                    arr[i] = "<font name='symbols' size='9'><color rgb='74B743'> &lt; </color></font>"
                end
            end
            p = arr.join " "
